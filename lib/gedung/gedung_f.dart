...
class BuildingFPage extends StatefulWidget {
  const BuildingFPage({super.key});

  @override
  State<BuildingFPage> createState() => _BuildingFPageState();
}

class _BuildingFPageState extends State<BuildingFPage> {
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: buildings["Gudang F"]!
                            ...
                            return Align(
                              alignment: roomPositions["Gudang F"]![index],
                              child: SizedBox(
                                width: 90,
                                height: 35,
                                child: TextButton(
                              ...
                              child: TextButton(
                                ...
                                style: TextButton.styleFrom(
                                  backgroundColor: Color(
                                      0xFFB31312), // Gunakan warna yang sesuai
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                ),
