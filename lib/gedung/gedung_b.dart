...
import 'package:aplikasi_gudang/models/rak.dart'; // Ensure this file contains the Room class
import 'package:http/http.dart' as http;
import 'dart:convert';

class BuildingBPage extends StatefulWidget {
  final String keyword;
  const BuildingBPage({super.key, required this.keyword});

  @override
  State<BuildingBPage> createState() => _BuildingBPageState();
}

class _BuildingBPageState extends State<BuildingBPage> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 80, left: 125),
