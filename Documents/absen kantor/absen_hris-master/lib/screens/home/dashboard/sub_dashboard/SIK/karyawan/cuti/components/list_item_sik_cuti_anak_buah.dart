...
class ListItemSikCutiAnakBuah extends StatefulWidget {
  final Sik sik;
  final Karyawan currUser;

  const ListItemSikCutiAnakBuah({
    super.key,
    required this.sik,
  ...
  @override
  State<ListItemSikCutiAnakBuah> createState() =>
      _ListItemSikCutiAnakBuahState();
}

class _ListItemSikCutiAnakBuahState extends State<ListItemSikCutiAnakBuah> {
  @override
