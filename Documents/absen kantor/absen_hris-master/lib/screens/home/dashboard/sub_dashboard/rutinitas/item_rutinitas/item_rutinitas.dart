...
class ListItemSummaryRutinitas extends StatefulWidget {
  final Lembur lembur;
  const ListItemSummaryRutinitas({super.key, required this.lembur});

  @override
  State<ListItemSummaryRutinitas> createState() =>
      _ListItemSummaryRutinitasState();
}

bool isOpen = false;

class _ListItemSummaryRutinitasState extends State<ListItemSummaryRutinitas> {
  String status = '';
  int statusNum = 0;
  late IconData icon;
            ...
            child: InkWell(
              ...
              child: Card(
                ...
                child: AnimatedContainer(
                  ...
                  padding: const EdgeInsets.only(
                      top: 14, bottom: 14, right: 6, left: 1),
                  child: Column(
                    children: [
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
