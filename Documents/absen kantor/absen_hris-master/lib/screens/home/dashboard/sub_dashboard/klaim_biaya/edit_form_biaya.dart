...
class EditFormKlaimBiaya extends StatefulWidget {
  final Biaya biaya;
  final Karyawan currUser;
  const EditFormKlaimBiaya({
    super.key,
    required this.biaya,
  ...
  @override
  State<EditFormKlaimBiaya> createState() => _EditFormKlaimBiayaState();
}

class _EditFormKlaimBiayaState extends State<EditFormKlaimBiaya> {
  final _formKey = GlobalKey<FormBuilderState>();
  String keperluanTerpilih = "";
  List<String> listKeperluanBiaya = ["Acara", "Transportasi"];
  ...
  _onEditSpkBtnPress() async {
    ...
    if (keperluanTerpilih == "Acara" && lampiranAcaraKwitansi == null) {
      int gacha = Random().nextInt(1000);
    ...
    if (keperluanTerpilih == "Transportasi" &&
    ...
    try {
      var request = http.MultipartRequest('POST',
          Uri.parse('$API_URL/v2/klaimBiaya/update/${widget.biaya.idBiaya}'))
  ...
  void initState() {
    super.initState();
    if (widget.biaya.tglKwintansi != null) {
      tglKwitansi = DateTime.parse(
          widget.biaya.tglKwintansi!); // Ensure tglIzin is not null
    } else {
      tglKwitansi = DateTime.now(); // Fallback to now if tglIzin is null
    }
    keperluanTerpilih = widget.biaya.jnsKlaimBiaya ?? '';
  }
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: FormBuilder(
                key: _formKey,
                initialValue: {
                  'nama_acara': widget.biaya.namaAcara,
                  'jenis_klaim_biaya': keperluanTerpilih,
                  'pembuat': widget.currUser.namaKaryawan,
                  'jumlah_uang': widget.biaya.jmlUang,
                  'deskripsi': widget.biaya.deskripsiUang,
                },
                child: Column(
                  ...
                  children: [
                                    ...
                                    children: [
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          ...
                                          await getLampiranAcara(); // Wait for getSuratDokter to complete
                                          setState(() {
                                            hideprogress =
                    ...
                    const CustomTextAreaUang(
                      header: "Jumlah uang yang diganti*",
                      textAreaName: "jumlah_uang",
                      labelText: "Mohon diisi jumlah nominal...",
                      isRequired: true,
                    ),
                    Container(
                      ...
                      child: const Text("Tanggal Kwitansi",
                          style: TextStyle(
                            ...
                            children: [
                              RichText(
                                text: const TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text: "Unggah bukti acara kwitansi*",
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
