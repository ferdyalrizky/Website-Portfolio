...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/izin/components/list_item_izin-riwayat.dart';
import 'package:intl/intl.dart';

import '../../../../../widgets/loader.dart';

class SummaryIzinAnakbuahRiwayat extends StatefulWidget {
  final Karyawan currUser;
  final List<Izin> listIzinAnakBuah;
  const SummaryIzinAnakbuahRiwayat({
    super.key,
  ...
  @override
  State<SummaryIzinAnakbuahRiwayat> createState() =>
      _SummaryIzinAnakbuahRiwayatState();
}

class _SummaryIzinAnakbuahRiwayatState
    extends State<SummaryIzinAnakbuahRiwayat> {
                        ...
                        : listIzinAnakBuah.isEmpty
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListItemIzinAnakBuahRiwayat(
