...
class ListItemLemburSpv extends StatefulWidget {
  final Lembur lembur;
  final Karyawan currUser;
  final Function onCallback;
  final bool isSummary;

  const ListItemLemburSpv({
    super.key,
  ...
  @override
  State<ListItemLemburSpv> createState() => _ListItemLemburSpvState();
}

bool isOpen = false;

class _ListItemLemburSpvState extends State<ListItemLemburSpv> {
  //Status Permintaan
  String status = '';
  int statusNum = 0;
