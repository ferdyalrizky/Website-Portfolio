...
class StatusAbsen extends StatefulWidget {
  final Karyawan currUser;
  final XFile? image;

  const StatusAbsen({super.key, required this.currUser, this.image});

  @override
  State<StatusAbsen> createState() => _StatusAbsenState(image);
}

class _StatusAbsenState extends State<StatusAbsen> {
  _StatusAbsenState(this.image);
  XFile? image;
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const Expanded(
                                          flex: 0, child: SizedBox(width: 18)),
                                      Expanded(
                                        flex: 0,
                                        child: Column(
                                          crossAxisAlignment:
