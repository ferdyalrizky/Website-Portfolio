...
class FormSikCutiKaryawanScreen extends StatefulWidget {
  final Karyawan currUser;
  final int jatahCutiUser;
  const FormSikCutiKaryawanScreen({
    super.key,
  ...
  @override
  State<FormSikCutiKaryawanScreen> createState() =>
      _FormSikCutiKaryawanScreenState();
}

class _FormSikCutiKaryawanScreenState extends State<FormSikCutiKaryawanScreen> {
  ...
  String kategoriCutiTerpilih = "Cuti Tahunan";
  ...
  _getCutiNormatifList() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('$API_URL/v2/listCutiNormatif'),
        headers: {
      ...
      try {
        ...
        if (response.statusCode == 201) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            // SnackBar(
            //   content: Text(
            //     "Buat Surat SIK Cuti Gagal. Hubungi Tim IT",
                        ...
                        child: FormBuilder(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (kategoriCutiTerpilih == "Cuti Normatif") ...[
                                CustomDropdownAndHeader(
                                  header: "Cuti Normatif",
                                  dropdownName: "cuti-normatif",
                                  items: listNameCutiNormatif,
                                  onChanged: (p0) {
                                    CutiNormatif cnSelected =
                                        listCutiNormatif.firstWhere((element) =>
                                            element.namaCuti == p0);
                                    setState(() {
