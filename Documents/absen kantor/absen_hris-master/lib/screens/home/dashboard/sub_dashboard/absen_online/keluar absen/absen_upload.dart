...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/keluar%20absen/status_absen.dart';
...
class AbsenPageKeluar extends StatefulWidget {
  final Karyawan currUser;
  final XFile? image;

  const AbsenPageKeluar({super.key, required this.currUser, this.image});

  @override
  State<AbsenPageKeluar> createState() => _AbsenPageKeluarState(image);
}

class _AbsenPageKeluarState extends State<AbsenPageKeluar> {
  _AbsenPageKeluarState(this.image);
  XFile? image;
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => StatusAbsenKeluar(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await _onAbsenOnlineBtnPress('check_out');
                  },
                  child: Text(
                    'Kirim',
                    style: TextStyle(
