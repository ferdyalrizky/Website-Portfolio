...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/kunjungan/baca_petunjuk.dart';
...
import '../../../../../../models/area_kerja.dart';

class AbsenOnlineScreenKunjungan extends StatefulWidget {
  //TODO: Nambah Data User untuk Absen Online push ke API
  final Karyawan currUser;

  const AbsenOnlineScreenKunjungan({
    super.key,
    required this.currUser,
  });

  @override
  State<AbsenOnlineScreenKunjungan> createState() =>
      _AbsenOnlineScreenKunjunganState();
}

class _AbsenOnlineScreenKunjunganState
    extends State<AbsenOnlineScreenKunjungan> {
  ...
  void listenToLocationChanges() {
    ...
    loc.onLocationChanged.listen((LocationData currentLocation) {
      setState(() {
        ...
        print(
            "Updated User Location: ${userCurrLoc!.latitude}, ${userCurrLoc!.longitude}");
        isInSelectedArea =
            _areaKerja.any((areaKerja) => checkIsInRadius(areaKerja));

        // Pindahkan kamera ke lokasi baru
        moveCameraMaps(LatLng(userCurrLoc!.latitude!, userCurrLoc!.longitude!));
      });
    });
  }
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              isInSelectedArea
                                  ? "Posisi kamu sudah di area kantor"
                                  : "Posisi kamu belum di area kantor",
                              style: TextStyle(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => BacaAturanKunjungan(
