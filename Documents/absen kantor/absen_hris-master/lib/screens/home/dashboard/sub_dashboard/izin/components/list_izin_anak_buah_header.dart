...
class ListSakitAnakBuahHeader extends StatelessWidget {
  final int totalIzinAnakBuah;
  final int totalMenungguApprove;
  final int totalMenungguVerif;
  final int totalApprove;
  const ListSakitAnakBuahHeader({
    super.key,
    required this.totalIzinAnakBuah,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: columnHeader(totalIzinAnakBuah, 'Total Izin'),
          ),
          Padding(
