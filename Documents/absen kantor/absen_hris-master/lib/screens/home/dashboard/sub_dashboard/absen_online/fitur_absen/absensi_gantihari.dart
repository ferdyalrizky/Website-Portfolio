...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/fitur_absen/edit_absen/history_absen.dart';
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/fitur_absen/form_gantihari.dart';
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/fitur_absen/list_item/list_item_gantihari.dart';
...
class AbsenOnlineGantihari extends StatefulWidget {
  final Karyawan currUser;
  final List<GantiHari> listGantiHariSendiri;
  const AbsenOnlineGantihari({
    super.key,
  ...
  @override
  State<AbsenOnlineGantihari> createState() => _AbsenOnlineGantihariState();
}

class _AbsenOnlineGantihariState extends State<AbsenOnlineGantihari> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                          onPressed: () {
                            _onCreateGantiHariBtnPress(user);
                          },
                          child: Row(
                            children: [
                              Text(
