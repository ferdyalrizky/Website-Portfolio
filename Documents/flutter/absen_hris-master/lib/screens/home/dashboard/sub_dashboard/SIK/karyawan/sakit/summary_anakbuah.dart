...
class SummarySakitAnakbuah extends StatefulWidget {
  final Karyawan currUser;
  final List<Sik> listSakitAnakBuah;
  const SummarySakitAnakbuah({
    super.key,
  ...
  @override
  State<SummarySakitAnakbuah> createState() => _SummarySakitAnakbuahState();
}

class _SummarySakitAnakbuahState extends State<SummarySakitAnakbuah> {
                ...
                child: loadingGetSakit
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return ListItemSikSakitAnakBuah(
