...
class ListHistoriManager extends StatefulWidget {
  final GantiHari gantihari;
  final Karyawan currUser;
  final Karyawan thisUser;
  final Function onCallback;
  const ListHistoriManager({
    super.key,
  ...
  @override
  State<ListHistoriManager> createState() => _ListHistoriManagerState();
}

class _ListHistoriManagerState extends State<ListHistoriManager> {
  //Status Permintaan
  String status = '';
  int statusNum = 0;
