...
class ListItemSikSakitAnakBuahRiwayat extends StatefulWidget {
  final Sik sik;

  const ListItemSikSakitAnakBuahRiwayat({
    super.key,
    required this.sik,
  });

  @override
  State<ListItemSikSakitAnakBuahRiwayat> createState() =>
      _ListItemSikSakitAnakBuahRiwayatState();
}

class _ListItemSikSakitAnakBuahRiwayatState
    extends State<ListItemSikSakitAnakBuahRiwayat> {
  @override
