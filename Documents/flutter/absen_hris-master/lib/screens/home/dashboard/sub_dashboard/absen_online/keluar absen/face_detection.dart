...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/keluar%20absen/absen_upload.dart';
...
class FaceDetectionAbsenKeluar extends StatefulWidget {
  final Karyawan currUser;
  const FaceDetectionAbsenKeluar({super.key, required this.currUser});

  @override
  State<FaceDetectionAbsenKeluar> createState() => _State();
}

class _State extends State<FaceDetectionAbsenKeluar>
                          ...
                          : ClipPath(
                              child: Transform(
                                ...
                                transform: Matrix4.rotationY(math
                                    .pi), // Flip the camera view horizontally
                                child: CameraPreview(controller!),
                              ),
                            ),
                ),
        ...
        if (faces.isNotEmpty) {
          ...
          if (isWearingMask) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => AbsenPageKeluar(
