...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/kunjungan/absen_upload.dart';
...
class FaceDetectionAbsenKunjungan extends StatefulWidget {
  final Karyawan currUser;
  const FaceDetectionAbsenKunjungan({super.key, required this.currUser});

  @override
  State<FaceDetectionAbsenKunjungan> createState() => _State();
}

class _State extends State<FaceDetectionAbsenKunjungan>
        ...
        if (faces.isNotEmpty) {
          ...
          if (isWearingMask) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => AbsenPageKunjungan(
