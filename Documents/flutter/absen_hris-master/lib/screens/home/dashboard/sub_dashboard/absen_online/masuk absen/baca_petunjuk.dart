...
class BacaAturan extends StatefulWidget {
  final Karyawan currUser;
  const BacaAturan({super.key, required this.currUser});

  @override
  State<BacaAturan> createState() => _BacaAturanState();
}

class _BacaAturanState extends State<BacaAturan> {
  int _countdown = 5;
