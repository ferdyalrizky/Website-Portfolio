...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/kunjungan/face_detection.dart';
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/kunjungan/status_absen.dart';
...
class AbsenPageKunjungan extends StatefulWidget {
  final Karyawan currUser;
  final XFile? image;

  const AbsenPageKunjungan({super.key, required this.currUser, this.image});

  @override
  State<AbsenPageKunjungan> createState() => _AbsenPageKunjunganState(image);
}

class _AbsenPageKunjunganState extends State<AbsenPageKunjungan> {
  _AbsenPageKunjunganState(this.image);
  XFile? image;
  ...
  //TODO nanti ganti sama location data dari API
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => StatusAbsenKunjungan(
            ...
            children: [
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => FaceDetectionAbsenKunjungan(
                          currUser: widget.currUser,
                        ),
                      ),
                    );
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await _onAbsenOnlineBtnPress('visit');
                  },
                  child: Text(
                    'Kirim',
                    style: TextStyle(
