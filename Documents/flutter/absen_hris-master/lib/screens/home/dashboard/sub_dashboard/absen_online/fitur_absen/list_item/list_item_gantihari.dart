...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/absen_online/fitur_absen/edit_absen/edit_absen.dart';
...
class ListItemGantihari extends StatefulWidget {
  final GantiHari gantihari;
  final Karyawan currUser;
  final Function onCallback;
  const ListItemGantihari({
    super.key,
  ...
  @override
  State<ListItemGantihari> createState() => _ListItemGantihariState();
}

class _ListItemGantihariState extends State<ListItemGantihari> {
  //Status Permintaan
  String status = '';
  int statusNum = 0;
  ...
  _onEditBtnPress() async {
    Route route = MaterialPageRoute(
        builder: (context) => EditAbsenGantiHari(
            gantihari: widget.gantihari, currUser: widget.currUser));
  ...
  onBatalkanBtnPress() async {
    ...
    var response = await http.get(
      Uri.parse('$API_URL/v2/gantiHari/cancel/${widget.gantihari.idHari}'),
      headers: {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: CustomSnackbarContent(
            title: "Success",
            msg: "Batalkan Ganti Hari Berhasil",
  ...
  _onApproveBtnPress() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            '$API_URL/v2/klaimBiaya/approve_data/${widget.gantihari.idHari}'),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer ${widget.currUser.apiToken}',
        },
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (statusNum >= 2
                                      ...
                                      : false) ...[
                                    KTimeLineStep(
                                      text: "Pengajuan disetujui oleh manager",
                                      date: "",
                                      time: "",
                                      isFirst: false,
                                      isLast: false,
