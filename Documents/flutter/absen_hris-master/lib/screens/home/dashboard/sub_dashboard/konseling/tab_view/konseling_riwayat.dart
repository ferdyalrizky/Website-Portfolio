...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/konseling/list/list_riwayat.dart';
import 'package:intl/intl.dart';
import '../../../../../../models/karyawan.dart';
import '../../../../../../widgets/loader.dart';

class SummaryKonselingScreenRiwayat extends StatefulWidget {
  final Karyawan currUser;
  final List<Counseling> listKonselingSendiri;
  const SummaryKonselingScreenRiwayat({
    super.key,
  ...
  @override
  State<SummaryKonselingScreenRiwayat> createState() =>
      _SummaryKonselingScreenRiwayatState();
}

class _SummaryKonselingScreenRiwayatState
    extends State<SummaryKonselingScreenRiwayat> {
                    ...
                    child: loadingGetKonseling || loadingkonselingall
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return ListItemKonselingRiwayat(
