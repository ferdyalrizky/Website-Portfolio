...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/SIK/karyawan/components/form_edit_sakit.dart';
...
class ListItemSikSakitSendiri extends StatefulWidget {
  final Sik sik;
  final Karyawan currUser;
  final Function onCallback;
  const ListItemSikSakitSendiri(
      {super.key,
      required this.sik,
  ...
  @override
  State<ListItemSikSakitSendiri> createState() =>
      _ListItemSikSakitSendiriState();
}

class _ListItemSikSakitSendiriState extends State<ListItemSikSakitSendiri> {
  @override
  Widget build(BuildContext context) {
    ...
    onEditBtnPress() async {
      Route route = MaterialPageRoute(
          builder: (context) =>
              FormEdit(sik: widget.sik, currUser: widget.currUser));
    ...
    return Padding(
      padding: const EdgeInsets.only(top: 14, bottom: 14, left: 17, right: 17),
                                ...
                                children: [
                                  ...
                                  if (widget.currUser.level! > 1) ...[
                                    ...
                                    if (statusNum >= 1) ...[
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah dikirimkan untuk menunggu disetujui manager",
                                        date: statusNum == 1
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                    ...
                                    if (statusNum >= 2 &&
                                      ...
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah disetujui manager",
                                        date: "",
                                        time: "",
                                        isFirst: false,
                                        isLast: false,
                                    ...
                                    if (statusNum == 3) ...[
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah disetujui HRD",
                                        date: statusNum == 3
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                                    widget.sik.updatedAt!))
                                    ...
                                    if (statusNum == 4) ...[
                                      KTimeLineStep(
                                        text: "Pengajuan sakit dibatalkan",
                                        date: statusNum == 4
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                                    widget.sik.updatedAt!))
                                    ...
                                    if (statusNum == 6) ...[
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah Disetujui oleh HRD",
                                        date: statusNum == 6
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                                    widget.sik.updatedAt!))
                                  ...
                                  if (widget.currUser.level! == 1) ...[
                                    ...
                                    if (statusNum >= 1) ...[
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah dikirimkan untuk menunggu disetujui owner",
                                        date: statusNum == 1
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                                    widget.sik.updatedAt!))
                                    ...
                                    if (statusNum >= 2 &&
                                      ...
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan sakit telah disetujui owner",
                                        date: "",
                                        time: "",
                                        isFirst: false,
                                        isLast: false,
