...
import '../edit_form_spk_lembur.dart';

class ListItemLemburSemua extends StatefulWidget {
  final Lembur lembur;
  final Karyawan currUser;
  final bool isSelected; // Selection state
  final ValueChanged<bool?> onChanged;
  const ListItemLemburSemua({
    super.key,
  ...
  @override
  State<ListItemLemburSemua> createState() => _ListItemLemburSemuaState();
}

bool isOpen = false;

class _ListItemLemburSemuaState extends State<ListItemLemburSemua> {
  //Status Permintaan
  String status = '';
  int statusNum = 0;
  String dibuatOleh = '';

  bool showEditButton1 = false;
  ...
  _onSetStatus() {
    setState(() {
      ...
      if (widget.lembur.createdBy == widget.currUser.id) {
  ...
  _onApproveBtnPress() async {
    ...
    try {
      var request = http.MultipartRequest('POST',
          Uri.parse('$API_URL/v2/approveSpkl/${widget.lembur.idLembur}'))
      ...
      if (response.statusCode == 201) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: CustomSnackbarContent(
              title: "Success",
              msg: "Approve SPKL Berhasil",
              contentType: ContentType.success,
            ),
          ),
        );
        setState(() {
          widget.lembur.status = 1;
          widget.lembur.disetujui = 1;
          widget.lembur.diverifikasi = 0;
          statusNum = 2;
          _onSetStatus();
  ...
  _onDitolakBtnPress() async {
    ...
    var response = await http.get(
      Uri.parse("$API_URL/v2/declineSpkl/${widget.lembur.idLembur}"),
      headers: {
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer ${widget.currUser.apiToken}',
      },
    ...
    if (response.statusCode == 201) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: CustomSnackbarContent(
            title: "Success",
            msg: "Penolakan SPKL Berhasil",
            contentType: ContentType.success,
          ),
        ),
      );
      setState(() {
        widget.lembur.status = 2;
        widget.lembur.disetujui = 0;
        widget.lembur.diverifikasi = 0;
        statusNum = 2;
        _onSetStatus();
                ...
                child: InkWell(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "${DateFormat('dd MMMM yyyy').format(DateTime.parse(widget.lembur.tglLembur!))} - ${DateFormat('dd MMMM yyyy').format(DateTime.parse(widget.lembur.tglLemburSelesai!))}",
                                              style: TextStyle(
                                                  fontSize: 13.sp,
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.w600),
                                    ...
                                    if (statusNum >= 1) ...[
                                      KTimeLineStep(
                                        text: "Pengajuan lembur telah dibuat",
                                        date: "",
                                        time: "",
                                        color: Colors.black,
                                        warna: Colors.grey,
                                      ...
                                      if (widget.currUser.level == 1) ...[
                                        if (statusNum >= 1) ...[
                                          ...
                                          if (statusNum >= 2 &&
                                            ...
                                            KTimeLineStep(
                                              text:
                                                  "Pengajuan lembur telah disetujui oleh owner",
                                              date: "",
                                              time: "",
                                              isFirst: false,
                                              isLast: false,
                                    ...
                                    if (widget.lembur.createdBy !=
                                      ...
                                      if (widget.currUser.level == 1) ...[
                                        if (statusNum >= 1) ...[
                                          KTimeLineStep(
                                            text: "Data dikirimkan ke manajer",
                                            date: statusNum == 1
                                                ? DateFormat('MMM d\n').format(
                                                    DateTime.parse(widget
                                                        .lembur.updatedAt!))
                                          ...
                                          if (statusNum >= 2 &&
                                            ...
                                            KTimeLineStep(
                                              text:
                                                  "Pengajuan lembur telah disetujui oleh manajer",
                                              date: "",
                                              time: "",
                                              isFirst: false,
                                              isLast: false,
                  ...
                  child: Card(
                    ...
                    child: AnimatedContainer(
                      ...
                      padding: const EdgeInsets.only(
                              top: 10, bottom: 20, right: 6, left: 1)
                          .r,
                      child: Center(
                        child: Column(
                          children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: TextStyle(
                                                  fontSize: 13
                                                      .sp, // Ensure you have a valid sp function or library
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.w600,
                                                ),
                                              ),
