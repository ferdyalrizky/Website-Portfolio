...
class ListItemLemburManager extends StatefulWidget {
  final Lembur lembur;
  final Karyawan currUser;
  final Function onCallback;
  const ListItemLemburManager({
    super.key,
  ...
  @override
  State<ListItemLemburManager> createState() => _ListItemLemburManagerState();
}

bool isOpen = false;

class _ListItemLemburManagerState extends State<ListItemLemburManager> {
  //Status Permintaan
  String status = '';
  int statusNum = 0;
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (statusNum >= 2 &&
                                      ...
                                      KTimeLineStep(
                                        text:
                                            "Pengajuan lembur telah disetujui owner",
                                        date: statusNum == 2
                                            ? DateFormat('MMM d\n').format(
                                                DateTime.parse(
                                                    widget.lembur.updatedAt!))
