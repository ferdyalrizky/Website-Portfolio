...
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/konseling/feedback/detail_feedback.dart';
import 'package:hris_v2/screens/home/dashboard/sub_dashboard/konseling/feedback/form_feedback.dart';
...
class _ListItemKonselingRiwayatState extends State<ListItemKonselingRiwayat> {
  ...
  late List<PertanyaanFeedback> pertanyaanfeedback = [];
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    FormFeedback(
                                                  currUser: widget
                                                      .currUser, // Pass the current user
                                                  konseling: widget.konseling,
                                                  pertanyaanfeedback:
                                                      pertanyaanfeedback,
                                                ),
                                              ),
