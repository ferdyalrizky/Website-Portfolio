...
class _FormKlaimRutinitasScreenState extends State<FormKlaimRutinitasScreen> {
  ...
  List<String> listKeperluanPertemuan = ["Online", "Offline"];
                ...
                children: [
                  ...
                  if (keperluanTerpilih == "Online") ...[
                    const CustomTextAreaAcara(
                      ...
                      textAreaName:
                          "link_pertemuan", // Change the textAreaName to something more appropriate
                      isRequired: true,
                    ),
                  ],
                  if (keperluanTerpilih == "Offline") ...[
                    const CustomTextAreaAcara(
                      ...
                      textAreaName:
                          "detail_lokasi", // Change the textAreaName to something more appropriate
                      isRequired: true,
                    ),
                  ],
                  Container(
