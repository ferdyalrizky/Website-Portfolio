...
class BacaAturanKunjungan extends StatefulWidget {
  final Karyawan currUser;
  const BacaAturanKunjungan({super.key, required this.currUser});

  @override
  State<BacaAturanKunjungan> createState() => _BacaAturanKunjunganState();
}

class _BacaAturanKunjunganState extends State<BacaAturanKunjungan> {
  int _countdown = 5;
