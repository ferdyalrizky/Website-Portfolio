...
class ListItemKonselingSendiri extends StatefulWidget {
  final Counseling konseling;
  final Karyawan currUser;
  const ListItemKonselingSendiri({
    super.key,
  ...
  @override
  State<ListItemKonselingSendiri> createState() =>
      _ListItemKonselingSendiriState();
}

class _ListItemKonselingSendiriState extends State<ListItemKonselingSendiri> {
  ...
  _onSetStatus() {
    ...
    if (widget.konseling.status == "reschedule") {
      status = "reschedule";
      statusNum = 5; // Pastikan status ini ditangani
    } else {
      print("Status tidak dikenali: ${widget.konseling.status}");
    }
  }
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          statusNum == 3
                                              ? "Ditolak"
                                              : statusNum == 1
                                                  ? "Menunggu Disetujui - Jadwal ulang"
                                                  : statusNum == 4
                                                      ? "Dibatalkan - Jadwal ulang"
                                                      : statusNum == 2
                                      ...
                                      if (statusNum >= 1) ...[
                                        KTimeLineStep(
                                          text: "Data dikirimkan ke Psikilog",
                                          date: statusNum == 1
                                              ? DateFormat('MMM d\n').format(
