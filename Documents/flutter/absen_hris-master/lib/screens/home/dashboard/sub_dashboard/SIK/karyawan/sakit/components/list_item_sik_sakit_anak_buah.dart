...
class ListItemSikSakitAnakBuah extends StatefulWidget {
  final Sik sik;
  final Karyawan currUser;
  const ListItemSikSakitAnakBuah({
    super.key,
    required this.sik,
  ...
  @override
  State<ListItemSikSakitAnakBuah> createState() =>
      _ListItemSikSakitAnakBuahState();
}

class _ListItemSikSakitAnakBuahState extends State<ListItemSikSakitAnakBuah> {
  @override
    ...
    onApproveBtnPress() async {
      ...
      try {
        final response = await http.get(
          Uri.parse('$API_URL/v2/approveSitc/${widget.sik.idSitc}'),
          headers: {
